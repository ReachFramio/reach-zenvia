    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            REACH Zenvia ensures that all documents follow a unified visual style using templates, grids, and design systems, helping brands maintain a strong identity.
          </p>
